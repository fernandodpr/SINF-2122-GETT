...
def insert_eventos(f, n):
    ...
    for i in range(n):
        ...
        query = f"\nINSERT INTO espectaculos VALUES ('{nombreEsp}', '{tipoEsp}', '{fechaProduccion}', '{productora}', '{participantes}', {penalizacion}, {tValidezReserva}, {tAntelacionReserva}, {tCancelacion});"
        f.write(query)
